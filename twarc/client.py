...
class Twarc(object):
    ...
    def favorites(self, user_id=None, screen_name=None, max_id=None,
                 since_id=None, max_pages=None):
        """
        Returns a collection of the most recent tweets liked
        by the user indicated by the user_id or screen_name parameter.
        Provide a user_id or screen_name.
        """
        ...
        id = screen_name or str(user_id)
        id_type = "screen_name" if screen_name else "user_id"
        log.info("starting user favorites for user %s", id)
    ...
    def mentions(self, user_id=None, screen_name=None, max_id=None,
                 since_id=None, max_pages=None):
        """
        Returns a collection of the most recent tweets mentioning
        the user indicated by the user_id or screen_name parameter.
        Provide a user_id or screen_name.
        """
        ...
        id = screen_name or str(user_id)
        id_type = "screen_name" if screen_name else "user_id"
        log.info("starting user mentions for user %s", id)
